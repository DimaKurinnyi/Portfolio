      ...
      <div className="w-5/12 smh:w-full">
        <div className="flex flex-col justify-center items-start">
          <HeroAnimate customDelay={1}>
            <h1 className="bg-gradient-to-r from-indigo-500  to-sky-500 inline-block text-transparent bg-clip-text mb-3 ">
              Dmytro Kurinnyi
            </h1>
          </HeroAnimate>
          <HeroAnimate customDelay={2}>
            <h3 className="text-2xl mb-3 lg:text-lg">Frontend Developer</h3>
          </HeroAnimate>
          <HeroAnimate customDelay={3}>
            <div className="text-[--color-ligh] mb-10 lg:text-sm">
              I am a novice frontend developer with an interest in creating interactive and creative
              websites. You strive to expand your skills in HTML, CSS and JavaScript, as well as
              learn modern frameworks and libraries for developing web applications. Your goal is to
              become an experienced developer capable of creating amazing user interfaces for web
              projects.
            </div>
          </HeroAnimate>
        </div>
        <HeroAnimate customDelay={4} customY={75}>
          <Link
            href="/contact"
            className="btn btn-custom_transparent text-xl lg:text-lg smh:text-center">
            Lets talk
          </Link>
        </HeroAnimate>
      </div>
